                        ...
                        <tr>
                            <td colspan="6">
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    @include('metronic.components.pagination', [ 'results' => $users ])
                                    @include('metronic.components.pagination-counter', ['results' => $users])
                                </div>
                            </td>
                        </tr>
                    </tfoot>
...
@push('quick-sidebar')
    @component('metronic.components.table-filter-quick-sidebar', [
