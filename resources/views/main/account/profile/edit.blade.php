                ...
                <div class="card p-5 row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="full_name" value="{{ old('full_name', $user->profile->full_name ?? null) }}">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="email" value="{{ old('email', $user->email ?? null) }}">
